...
public class BigWigSectionHeader {
    ...
    private static Logger log = Logger.getLogger(BigWigSectionHeader.class.getCanonicalName());
    ...
    * */
    public BigWigSectionHeader(LittleEndianInputStream lbdis) {
        ...
        try {
            ...
            log.log(Level.SEVERE,"Error reading wig section header ", ex);
    ...
    * */
    ...
    public void print(){
        ...
        log.info("Chromosome ID = " + chromID);
        log.info("ChromStart = " + chromStart);
        log.info("ChromEnd = " + chromEnd);
        log.info("ItemStep = " + itemStep);
        log.info("ItemSpan = " + itemSpan);
        log.info("ItemType = " + itemType);
        log.info("mReserved = " + reserved);
        log.info("mItemCount = " + itemCount);
    }
