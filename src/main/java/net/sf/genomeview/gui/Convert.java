...
public class Convert {
	 ...
	 * 
	 * @param pos         the genome nucleotide position
	 * @param r           the visible range of the current view
	 * @param screenWidth width of window in pixels
	 * @return
	 */
	 ...
	 * only needed for the X coordinate
	 * 
	 * @param g   the graphics context for the visible Location
	 * @param pos the position to translate,
	 * 
	 * @return
	 */
	public static int translateScreenToGenome(int pos, Location r,
			double screenWidth) {
