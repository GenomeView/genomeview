...
public class HideFeatureSelectionAction extends AbstractModelAction implements Observer {
    ...
    public HideFeatureSelectionAction(Model model) {
        super("Hide feature selection", model);
    }

    public void actionPerformed(ActionEvent e) {
        Set<Feature> selected = model.getFeatureSelection();
        for (Feature f : selected)
            model.setFeatureVisible(f, false);
