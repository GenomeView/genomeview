...
public class LoadFeaturesAction extends AbstractAction {
    ...
    public void actionPerformed(ActionEvent arg0) {
        ...
        if (source != null) {
            DataSource[] data = DataSourceFactory.create(source, model,new String[]{"fasta","fa","fas","embl","fna","gtf","gff","gff3","maln","syn","wig","mfa","bed","mapview","bai","maf","snp","tbl","gb","gbk","pileup","con"});
            if (data != null) {
