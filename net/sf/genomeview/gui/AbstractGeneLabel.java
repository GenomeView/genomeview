...
public abstract class AbstractGeneLabel extends JLabel implements Observer {
    ...
    public AbstractGeneLabel(final Model model) {
        ...
        this.addMouseWheelListener(new MouseWheelListener() {
            ...
            public void mouseWheelMoved(MouseWheelEvent e) {
                ...
                int newStart = (int) (start - rot * length);
                int newEnd = (int) (end + rot * length);
    ...
    protected void paintVisibilityFrame(Graphics g, Location frame, Location real) {

        g.setColor(Color.RED);

        int start = translateGenomeToScreen(frame.start(), real);
        int end = translateGenomeToScreen(frame.end(), real);
        g.drawRect(start, 0, end - start, framePixelsUsed > g.getClipBounds().height ? framePixelsUsed - 1 : g
