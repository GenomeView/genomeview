...
public class Model extends Observable implements Observer, IModel {
    ...
    private Map<Type, Boolean> showTextOnStructure = new DefaultHashMap<Type, Boolean>(Boolean.FALSE);
    ...
    private Map<Type, Boolean> visibleOnAnnotation = new DefaultHashMap<Type, Boolean>(Boolean.FALSE);
    ...
    private Map<IValueFeature, Boolean> valueFeatureVisible = new DefaultHashMap<IValueFeature, Boolean>(Boolean.TRUE);
    ...
    public Entry[] addFeatures(DataSource f) throws ReadFailedException {
        ...
        for (Entry e : data) {
            ...
            for (Entry g : entries) {
                if (g.description.getPrimaryAccessionNumber().equals(e.description.getPrimaryAccessionNumber())) {
                    addTo = g;
                }
            }
    ...
    private DefaultHashMap<Type, Boolean> visibleOnStructure = new DefaultHashMap<Type, Boolean>(Boolean.FALSE);
